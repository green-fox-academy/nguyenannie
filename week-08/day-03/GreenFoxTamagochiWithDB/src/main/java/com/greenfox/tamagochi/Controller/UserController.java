...
public class UserController {
    ...
    public String nutrition(Model model, @PathVariable String username, HttpServletRequest req) {
        Fox afox = userServiceDB.getOneUserByName(username).getFox();
        if(afox.getFood() == null) {
            history.add(LocalDateTime.now() + " Food has been added is " + req.getParameter("addfoodhere"));
        } else if(!afox.getFood().equals(req.getParameter("addfoodhere"))){
            history.add(LocalDateTime.now() + " Food has been change from "
                    + afox.getFood() + " to " + req.getParameter("addfoodhere"));
        }

        if(afox.getFood() == null) {
            history.add(LocalDateTime.now() + " Drink has been added is " + req.getParameter("adddrinkhere"));
        } else if(!afox.getDrink().equals(req.getParameter("adddrinkhere"))) {
...
//        Fox fox = userServiceDB.getOneUserByName(username).getFox();
//
...
//        System.out.println("PRE updateFox fox " + fox);
//        foxServiceDB.updateFox(fox);
//        System.out.println("POST updateFox fox " + fox);
//        System.out.println("newTrick " + newTrick);
//        System.out.println("foxTricks " + fox.getTricks());
//        System.out.println("foxTricks DB " + userServiceDB.getOneUserByName(username).getFox().getTricks());
//
